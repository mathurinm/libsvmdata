...
DATASETS = [
    ...
    LibsvmDataset("w3a", "w3a", "binary", 300),
    LibsvmDataset("w3a_test", "w3a.t", "binary", 300),
    LibsvmDataset("w4a", "w4a", "binary", 300),
    LibsvmDataset("w4a_test", "w4a.t", "binary", 300),
    LibsvmDataset("w5a", "w5a", "binary", 300),
    LibsvmDataset("w5a_test", "w5a.t", "binary", 300),
    LibsvmDataset("w6a", "w6a", "binary", 300),
    LibsvmDataset("w6a_test", "w6a.t", "binary", 300),
