...
class LibsvmDataset(AbstractDataset):
    ...
    def _load_file_and_save_data(self, raw_dataset_path, ext_dataset_path):
        ...
        if str(raw_dataset_path).endswith(".bz2"):
            ...
            with open(tmp_dataset_path, "wb") as f, open(raw_dataset_path, "rb") as g:
...
DATASETS = [
    ...
    LibsvmDataset("covtype.multiclass_scale", "covtype.scale01.bz2", "multiclass", 54),
    ...
    LibsvmDataset("liver-disorders_scale", "liver-disorders_scale", "binary", 5),
    ...
    LibsvmDataset("mediamill", "mediamill/train-exp1.svm.bz2", "multilabel", 120),
    LibsvmDataset("mediamill_test", "mediamill/test-exp1.svm.bz2", "multilabel", 120),
    ...
    LibsvmDataset("rcv1.multiclass", "rcv1_train.multiclass.bz2", "multiclass", 47236),
    LibsvmDataset(
    ...
    LibsvmDataset("scene-classification", "scene_train.bz2", "multilabel", 294),
    LibsvmDataset("scene-classification_test", "scene_test.bz2", "multilabel", 294),
    LibsvmDataset("sector.scale", "sector/sector.scale.bz2", "multiclass", 55197),
    LibsvmDataset(
    ...
    LibsvmDataset("siam-competition2007", "tmc2007_train.svm.bz2", "multilabel", 30438),
    LibsvmDataset(
        "siam-competition2007_test", "tmc2007_test.svm.bz2", "multilabel", 30438
    ),
    ...
    LibsvmDataset("YearPredictionMSD", "YearPredictionMSD.bz2", "regression", 90),
    LibsvmDataset(
